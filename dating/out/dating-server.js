function Top (rt) {
  ...
  this.gensym356 = function ($env,arg1121) {
    const gensym362 = rt.__unit;
    const gensym360 = rt.eq (arg1121,gensym362);;
    const gensym361 = rt.mkValPos ("pattern match failed",'');;
    rt.assertOrError (gensym360);
    if (rt.getVal(gensym360)) {
      const gensym359 = rt.mkVal(rt.mkList([]));
      rt.push ((gensym357) =>
               {const gensym358 = rt.mkVal(rt.mkList([]));
                rt.tailcall (gensym357,gensym358);});
      rt.tailcall ($env.server73,gensym359);
    } else {
      rt.errorPos (gensym361,'');
    }
  }
  this.gensym356.deps = [];
  this.gensym356.libdeps = [];
  this.gensym356.serialized = "";
  ...
  this.gensym2 = function ($env,cmp_arg35) {
                                                                                                                             ...
                                                                                                                             {rt.push ((gensym45) =>
                                                                                                                                       {rt.branch (gensym45);
                                                                                                                                        if (rt.getVal(gensym45)) {
                                                                                                                                          ...
                                                                                                                                          const gensym44 = rt.mkVal(rt.mkTuple([gensym108, $env.gensym384, gensym43]));
                                                                                                                                          rt.push ((gensym41) =>
                                                                                                                                                   {rt.push ((gensym36) =>
                                                                                                                                                             {rt.branch (gensym36);
                                                                                                                                                              if (rt.getVal(gensym36)) {
                                                                                                                                                                ...
                                                                                                                                                                rt.tailcall (gensym28,$env.gensym384);
                                                                                                                                                              } else {
                                                                                                                                                                rt.push (($decltemp$55) =>
                                                                                                                                                    ...
                                                                                                                                                    if (rt.getVal(gensym41)) {
                                                                                                                                                      ...
                                                                                                                                                      const gensym39 = rt.mkVal(rt.mkTuple([gensym63, $env.gensym384, gensym38]));
                                                                                                                   ...
                                                                                                                   {rt.push ((gensym57) =>
                                                                                                                             {rt.push ((gensym50) =>
                                                                                                                                       {const gensym51 = rt.mkLabel("");
                                                                                                                                        const gensym52 = rt.mkVal(rt.mkTuple([gensym50, $env.gensym384, gensym51]));
    ...
    rt.tailcall (gensym143,$env.gensym384);
  }
  this.gensym2.deps = [];
  this.gensym2.libdeps = ['lists'];
  this.gensym2.serialized = "";
  this.gensym1 = function ($env,cmp_arg24) {
    const $$$env6 = new rt.Env();
    $$$env6.cmp_arg24 = cmp_arg24;
    $$$env6.cmp_arg13 = $env.cmp_arg13;
    $$$env6.gensym384 = $env.gensym384;
  ...
  this.gensym1.serialized = "";
  this.cmp2 = function ($env,cmp_arg13) {
    const $$$env7 = new rt.Env();
    $$$env7.cmp_arg13 = cmp_arg13;
    $$$env7.gensym384 = $env.gensym384;
  ...
  this.cmp2.libdeps = [];
  this.cmp2.serialized = "AAAAAAAAAAAEY21wMgAAAAAAAAAJY21wX2FyZzEzAAAAAAAAAAEBAAAAAAAAAAIAAAAAAAAACWNtcF9hcmcxMwAAAAAAAAAACWNtcF9hcmcxMwAAAAAAAAAJZ2Vuc3ltMzg0AQAAAAAAAAAJZ2Vuc3ltMzg0AAAAAAAAAAEAAAAAAAAAB2dlbnN5bTEAAAAAAAAAB2dlbnN5bTEBAAAAAAAAAAAHZ2Vuc3ltMQ==";
  this.main = function ($env,$$authorityarg) {
    const gensym384 = $$authorityarg;
    const $$$env8 = new rt.Env();
    $$$env8.gensym384 = gensym384;
    ...
    const gensym383 = rt.__unit;
    rt.push ((gensym382) =>
             {rt.ret (gensym382);});
    const gensym373 = rt.__unit;
    const gensym370 = rt.eq (gensym383,gensym373);;
    const gensym371 = rt.mkValPos ("pattern match failure in function main",'');;
    rt.assertOrError (gensym370);
    if (rt.getVal(gensym370)) {
      rt.push (($decltemp$116) =>
               {rt.push (($decltemp$118) =>
                         {rt.push (($decltemp$120) =>
                                   {rt.push (($decltemp$123) =>
                                             {const gensym341 = rt.__unit;
                                              rt.ret (gensym341);});
                                    const gensym342 = rt.mkCopy(rt.send);
                                    const gensym347 = rt.mkCopy(rt.whereis);
                                    const gensym348 = rt.mkValPos ("@dispatcher",'');;
                                    const gensym349 = rt.mkValPos ("dispatcher",'');;
                                    const gensym350 = rt.mkVal(rt.mkTuple([gensym348, gensym349]));
                                    rt.push ((gensym343) =>
                                             {const gensym344 = rt.mkValPos ("DISPATCH",'');;
                                              const gensym345 = rt.mkVal(rt.mkTuple([gensym344, $decltemp$116]));
                                              const gensym346 = rt.mkVal(rt.mkTuple([gensym343, gensym345]));
                                              rt.tailcall (gensym342,gensym346);});
                                    rt.tailcall (gensym347,gensym350);});
                          const gensym351 = rt.mkCopy(rt.register);
                          const gensym352 = rt.mkValPos ("datingServer",'');;
                          const gensym355 = rt.mkCopy(rt.spawn);
                          const $$$env11 = new rt.Env();
                          $$$env11.server73 = server73;
                          const gensym356 = rt.mkVal(new rt.Closure($$$env11, this, this.gensym356))
                          $$$env11.gensym356 = gensym356;
                          $$$env11.gensym356.selfpointer = true;
                          rt.push ((gensym353) =>
                                   {const gensym354 = rt.mkVal(rt.mkTuple([gensym352, gensym353, gensym384]));
                                    rt.tailcall (gensym351,gensym354);});
                          rt.tailcall (gensym355,gensym356);});
                const gensym363 = rt.mkCopy(rt.printString);
                const gensym365 = rt.mkValPos ("Running node with identifier: ",'');;
                const gensym364 = rt.stringConcat (gensym365,$decltemp$116);;
                rt.tailcall (gensym363,gensym364);});
      const gensym366 = rt.mkCopy(rt.node);
      const gensym368 = rt.mkCopy(rt.self);
      const gensym369 = rt.__unit;
      rt.push ((gensym367) =>
               {rt.tailcall (gensym366,gensym367);});
      rt.tailcall (gensym368,gensym369);
    } else {
      rt.errorPos (gensym371,':79:9');
    }
  }
  this.main.deps = ['cmp2', 'match57', 'server73', 'gensym356'];
  this.main.libdeps = [];
  this.main.serialized = "";
}
module.exports = Top 